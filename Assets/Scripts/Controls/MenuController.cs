...
public class MenuController : MonoBehaviour
{
    ...
    [SerializeField]
    GraphicRaycaster squadMenuRaycaster = null;

    public GraphicRaycaster BuildMenuRaycaster { get; private set; }
    public GraphicRaycaster SquadMenuRaycaster
    {
        get { return squadMenuRaycaster; }
        private set { squadMenuRaycaster = value; }
    }
    ...
    void Awake()
    {
        ...
        {
            Debug.LogWarning("FactoryMenuCanvas is not assigned in inspector");
        }

        if (squadMenuRaycaster == null)
        {
            Debug.LogWarning("SquadMenuRaycaster is not assigned in inspector");
        }
